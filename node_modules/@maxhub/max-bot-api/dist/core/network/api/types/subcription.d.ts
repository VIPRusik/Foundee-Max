...
export type Update = BotAddedUpdate | BotStartedUpdate | BotStoppedUpdate | BotRemovedUpdate | ChatTitleChangedUpdate | CommentCreatedUpdate | CommentEditedUpdate | CommentRemovedUpdate | DialogClearedUpdate | DialogMutedUpdate | DialogRemovedUpdate | DialogUnmutedUpdate | MessageCallbackUpdate | MessageCreatedUpdate | MessageEditedUpdate | MessageRemovedUpdate | UserAddedUpdate | UserRemovedUpdate;
...
export type FilteredUpdate<Type extends UpdateType> = Type extends keyof UpdateMap ? UpdateMap[Type] : never;
