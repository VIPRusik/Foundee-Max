...
export type ChatPermissions = 'read_all_messages' | 'add_remove_members' | 'add_admins' | 'change_chat_info' | 'pin_message' | 'write' | 'can_call' | 'edit_link' | 'post_edit_delete_message' | 'edit_message' | 'delete_message' | 'edit' | 'delete';
