...
import { AddChatAdminsDTO, AddChatAdminsResponse, AddChatMembersDTO, AddChatMembersResponse, DeleteAdminChatMemberDTO, DeleteAdminChatMemberResponse, EditChatInfoDTO, EditChatInfoResponse, GetAllChatsDTO, GetAllChatsResponse, GetChatAdminsDTO, GetChatAdminsResponse, GetChatByIdDTO, GetChatByIdResponse, GetChatMembersDTO, GetChatMembershipDTO, GetChatMembershipResponse, GetChatMembersResponse, GetPinnedMessageDTO, GetPinnedMessageResponse, LeaveChatDTO, LeaveChatResponse, PinMessageDTO, PinMessageResponse, RemoveChatMemberDTO, RemoveChatMemberResponse, SendActionDTO, SendActionResponse, UnpinMessageDTO, UnpinMessageResponse } from './chats/types';
import { DeleteCommentDTO, DeleteCommentResponse, EditCommentDTO, EditCommentResponse, GetCommentDTO, GetCommentResponse, GetCommentsDTO, GetCommentsResponse, SendCommentDTO, SendCommentResponse } from './comments/types';
import { AnswerOnCallbackDTO, AnswerOnCallbackResponse, DeleteMessageDTO, DeleteMessageResponse, EditMessageDTO, EditMessageResponse, GetMessageDTO, GetMessageResponse, GetMessagesDTO, GetMessagesResponse, GetVideoInfoDTO, GetVideoInfoResponse, SendMessageDTO, SendMessageResponse } from './messages/types';
import { GetUpdatesDTO, GetUpdatesResponse, SubscribeOnUpdatesDTO, SubscribeOnUpdatesResponse, SubscriptionsResponseDTO, UnsubscribeFromUpdatesDTO, UnsubscribeFromUpdatesResponse } from './subscriptions/types';
